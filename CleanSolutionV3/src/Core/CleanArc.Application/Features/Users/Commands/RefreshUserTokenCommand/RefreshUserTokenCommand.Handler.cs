...
internal class
    RefreshUserTokenCommandHandler : IRequestHandler<RefreshUserTokenCommand, OperationResult<AccessToken>>
{
    ...
    public async ValueTask<OperationResult<AccessToken>> Handle(RefreshUserTokenCommand request,
