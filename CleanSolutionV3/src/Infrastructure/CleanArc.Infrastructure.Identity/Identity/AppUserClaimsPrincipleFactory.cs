...
{
    public AppUserClaimsPrincipleFactory(AppUserManager userManager, AppRoleManager roleManager,
    ...
    protected override async Task<ClaimsIdentity> GenerateClaimsAsync(User user)
    {
        ...
        foreach (var roles in userRoles) claimsIdentity.AddClaim(new Claim(ClaimTypes.Role, roles));
